...
const CounsellingBanner = ({ text, para,para2  }) => {
  ...
  return (
    <div className="banner mt-[80px] bg-red-300 grid grid-cols-3 ">
      <div className="relative h-full  justify-start w-full ">
        <img className='h-full w-full ' src="https://www.careerguide.com/career/wp-content/uploads/2023/06/Career-Options-after-12th.webp" alt="Banner Image" />
      </div>    
      <div className=" w-[90%]">
        <h1 className='text-white leading-[1em] text-[3em]'>{text}</h1>
        <p className='my-[40px] text-black'>{para}</p>
        <p className='text-black mb-[20px]'>{para2}</p>
      </div>
