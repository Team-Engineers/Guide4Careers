    ...
    <>
      ...
      >
        <SwiperSlide data-hash="slide1">
          <div className="col-span-1 shadow-2xl max-md:h-[500px] md:h-[400px] my-4  mx-[20px] rounded-3xl">
            <div className="text-center font-medium">
              <img
                ...
                alt=""
              />
              <p className=" text-[blue] mx-auto md:mt-[-90px]">Sita Ramaswami</p>
              <p className=" mx-auto">
                BBA, Depauw University</p>
          ...
          <div className="col-span-1 shadow-2xl max-md:h-[500px] md:h-[400px] my-4  mx-[20px] rounded-3xl">
            <div className="text-center font-medium">
              <img
                ...
                alt=""
              />
              <p className=" text-[blue] mx-auto md:mt-[-90px]">Anirban Saren</p>
