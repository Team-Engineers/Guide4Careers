    ...
    <div className="mt-[80px] bg-red-300   grid grid-cols-3">
      <div className=" flex  items-end ">
        <img
          ...
          src="https://www.careerguide.com/career/wp-content/uploads/2023/06/Career-Options-after-12th.webp"
          alt="Banner"
        />
      </div>
      <div className="">
        <h1
          style={{ textShadow: "2px 2px 4px rgba(18, 12, 11, 0.99)" }}
          className="text-white banner_text leading-[1em] text-[2.5em] mt-[40px] "
        >
          {text}
        </h1>
